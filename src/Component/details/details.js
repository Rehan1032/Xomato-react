...
const rurl = "https://myzom-app.herokuapp.com/details";
const murl = "https://myzom-app.herokuapp.com/menu";
class Details extends Component {
            ...
            <>
                ...
                <div id="mainContent">
                    <div className="imgDiv">
                        <img src={details.restaurant_thumb} alt="img"/>
                    </div>
                    <div className="contentDiv">
                        ...
                        <div class="feature_container">
                            <figure>
                                <img src="https://i.ibb.co/wJvrhYg/veg.png" class="featureIcon" alt='img'/>
    ...
    async componentDidMount(){
        ...
        sessionStorage.setItem("mealId",menudata.data[0].meal);
